...
use App\Filament\Clusters\InvenLabH\Resources\InventarisPCLaboratoriumHResource\Pages;
use App\Filament\Clusters\InvenLabH\Resources\InventarisPCLaboratoriumHResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_H;
use App\Models\InventarisPCLaboratoriumH;
use Filament\Forms;
...
class InventarisPCLaboratoriumHResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_H::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabH::class;

    protected static ?string $slug = 'pc-h';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumHS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumH::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumH::route('/{record}/edit'),
        ];
    }
}
