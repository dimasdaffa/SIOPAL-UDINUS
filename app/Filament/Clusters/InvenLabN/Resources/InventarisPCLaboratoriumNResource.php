...
use App\Filament\Clusters\InvenLabN\Resources\InventarisPCLaboratoriumNResource\Pages;
use App\Filament\Clusters\InvenLabN\Resources\InventarisPCLaboratoriumNResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_N;
use App\Models\InventarisPCLaboratoriumN;
use Filament\Forms;
...
class InventarisPCLaboratoriumNResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_N::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabN::class;

    protected static ?string $slug = 'pc-n';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumNS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumN::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumN::route('/{record}/edit'),
        ];
    }
}
