...
use App\Filament\Clusters\InvenLabL\Resources\InventarisPCLaboratoriumLResource\Pages;
use App\Filament\Clusters\InvenLabL\Resources\InventarisPCLaboratoriumLResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_L;
use App\Models\InventarisPCLaboratoriumL;
use Filament\Forms;
...
class InventarisPCLaboratoriumLResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_L::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabL::class;

    protected static ?string $slug = 'pc-l';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumLS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumL::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumL::route('/{record}/edit'),
        ];
    }
}
