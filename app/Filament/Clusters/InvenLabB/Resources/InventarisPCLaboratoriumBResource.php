...
use App\Filament\Clusters\InvenLabB\Resources\InventarisPCLaboratoriumBResource\Pages;
use App\Filament\Clusters\InvenLabB\Resources\InventarisPCLaboratoriumBResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_B;
use App\Models\InventarisPCLaboratoriumB;
use Filament\Forms;
...
class InventarisPCLaboratoriumBResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_B::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabB::class;

    protected static ?string $slug = 'pc-b';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumBS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumB::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumB::route('/{record}/edit'),
        ];
    }
}
