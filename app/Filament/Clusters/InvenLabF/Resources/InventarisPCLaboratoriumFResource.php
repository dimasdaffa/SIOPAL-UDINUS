...
use App\Filament\Clusters\InvenLabF\Resources\InventarisPCLaboratoriumFResource\Pages;
use App\Filament\Clusters\InvenLabF\Resources\InventarisPCLaboratoriumFResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_F;
use App\Models\InventarisPCLaboratoriumF;
use Filament\Forms;
...
class InventarisPCLaboratoriumFResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_F::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabF::class;

    protected static ?string $slug = 'pc-f';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumFS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumF::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumF::route('/{record}/edit'),
        ];
    }
}
