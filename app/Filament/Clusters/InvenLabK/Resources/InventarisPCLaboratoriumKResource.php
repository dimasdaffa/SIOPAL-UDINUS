...
use App\Filament\Clusters\InvenLabK\Resources\InventarisPCLaboratoriumKResource\Pages;
use App\Filament\Clusters\InvenLabK\Resources\InventarisPCLaboratoriumKResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_K;
use App\Models\InventarisPCLaboratoriumK;
use Filament\Forms;
...
class InventarisPCLaboratoriumKResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_K::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabK::class;

    protected static ?string $slug = 'pc-k';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumKS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumK::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumK::route('/{record}/edit'),
        ];
    }
}
