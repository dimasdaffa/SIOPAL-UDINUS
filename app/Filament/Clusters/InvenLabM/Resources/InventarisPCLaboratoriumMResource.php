...
use App\Filament\Clusters\InvenLabM\Resources\InventarisPCLaboratoriumMResource\Pages;
use App\Filament\Clusters\InvenLabM\Resources\InventarisPCLaboratoriumMResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_M;
use App\Models\InventarisPCLaboratoriumM;
use Filament\Forms;
...
class InventarisPCLaboratoriumMResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_M::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabM::class;

    protected static ?string $slug = 'pc-m';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumMS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumM::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumM::route('/{record}/edit'),
        ];
    }
}
