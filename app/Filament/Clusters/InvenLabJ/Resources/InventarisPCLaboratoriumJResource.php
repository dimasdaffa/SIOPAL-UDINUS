...
use App\Filament\Clusters\InvenLabJ\Resources\InventarisPCLaboratoriumJResource\Pages;
use App\Filament\Clusters\InvenLabJ\Resources\InventarisPCLaboratoriumJResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_J;
use App\Models\InventarisPCLaboratoriumJ;
use Filament\Forms;
...
class InventarisPCLaboratoriumJResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_J::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabJ::class;

    protected static ?string $slug = 'pc-j';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumJS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumJ::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumJ::route('/{record}/edit'),
        ];
    }
}
