...
use App\Filament\Clusters\InvenLabG\Resources\InventarisPCLaboratoriumGResource\Pages;
use App\Filament\Clusters\InvenLabG\Resources\InventarisPCLaboratoriumGResource\RelationManagers;
use App\Models\Inventaris_PC_Laboratorium_G;
use App\Models\InventarisPCLaboratoriumG;
use Filament\Forms;
...
class InventarisPCLaboratoriumGResource extends Resource
{
    protected static ?string $model = Inventaris_PC_Laboratorium_G::class;

    protected static ?string $navigationIcon = 'clarity-computer-solid';

    protected static ?string $cluster = InvenLabG::class;

    protected static ?string $slug = 'pc-g';
    ...
    {
        return [
            'index' => Pages\ListInventarisPCLaboratoriumGS::route('/'),
            // 'create' => Pages\CreateInventarisPCLaboratoriumG::route('/create'),
            // 'edit' => Pages\EditInventarisPCLaboratoriumG::route('/{record}/edit'),
        ];
    }
}
