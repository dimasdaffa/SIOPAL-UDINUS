...
use App\Filament\Resources\InventarisNonPCLaboratoriumAResource\Pages;
use App\Filament\Resources\InventarisNonPCLaboratoriumAResource\RelationManagers;
use App\Models\Inventaris_Non_PC_Laboratorium_A;
use App\Models\InventarisNonPCLaboratoriumA;
use Filament\Forms;
...
class InventarisNonPCLaboratoriumAResource extends Resource
{
    protected static ?string $model = Inventaris_Non_PC_Laboratorium_A::class;

    protected static ?string $navigationIcon = 'fluentui-box-24-o';

    protected static ?string $slug = 'non-pc-a';
