...
class Inventaris_PC_Laboratorium_A extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($invLABA) {
            $lastId = self::max('id') + 1;
            $kodeUnik = str_pad($lastId, 2, '0', STR_PAD_LEFT);
            $invLABA->no_inventaris = 'UDN/LABKOM/INV/D2A/PC' . $kodeUnik;
        });
    }
